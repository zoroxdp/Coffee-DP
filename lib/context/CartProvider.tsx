import { useState, useEffect, createContext, useContext, useMemo, useCallback, Dispatch, SetStateAction } from 'react';
...
const CartProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const value = useMemo(() => ({
    cart, error, loading, showShoppingCart, addItem, removeItem, updateCart, setShowShoppingCart
  }),
    [cart, error, loading, showShoppingCart, addItem, removeItem, updateCart, setShowShoppingCart]
  )
